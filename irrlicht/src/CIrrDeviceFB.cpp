...
bool CIrrDeviceFB::run()
{
	...
	if (EventDevice>=0)
	{
		...
		if (ev.type == EV_KEY)
		{
			...
			irrevent.Info.KeyInput.PressedDown = true;
			
			switch (ev.code)
			{
				case KEY_RIGHTCTRL:
				case KEY_LEFTCTRL:
					irrevent.Info.KeyInput.Control = true;
				break;
				case KEY_RIGHTSHIFT:
				case KEY_LEFTSHIFT:
					irrevent.Info.KeyInput.Shift = true;
				break;
				case KEY_ESC:
					irrevent.Info.KeyInput.Key = (EKEY_CODE)0x1B;
				break;
				case KEY_SPACE:
					irrevent.Info.KeyInput.Key = (EKEY_CODE)0x20;
				break;
				case KEY_UP:
					irrevent.Info.KeyInput.Key = (EKEY_CODE)0x26;
				break;
				case KEY_LEFT:
					irrevent.Info.KeyInput.Key = (EKEY_CODE)0x25;
				break;
				case KEY_RIGHT:
					irrevent.Info.KeyInput.Key = (EKEY_CODE)0x27;
				break;
				case KEY_DOWN:
					irrevent.Info.KeyInput.Key = (EKEY_CODE)0x28;
				break;
				default:
