...
private:
	...
	bool load();
	bool readChunkNODE(SJoint* InJoint);
	bool readChunkMESH(SJoint* InJoint);
	bool readChunkVRTS(SJoint* InJoint);
	bool readChunkTRIS(scene::SSkinMeshBuffer *MeshBuffer, u32 MeshBufferID, s32 Vertices_Start);
	bool readChunkBONE(SJoint* InJoint);
	bool readChunkKEYS(SJoint* InJoint);
	bool readChunkANIM();
	bool readChunkTEXS();
	bool readChunkBRUS();
