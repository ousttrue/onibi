...
public:
	...
	virtual core::matrix4 getAccumulation(f32 scaling)const=0;
	virtual void setAccumulation(const core::matrix4 &m)=0;
	virtual void setAccumulation(const core::matrix4 &m, f32 scaling)=0;
	virtual core::vector3df getAccumulatedPosition()const=0;
	virtual core::vector3df getAccumulatedPosition(f32 scaling)const=0;
