...
core::array<SJoint*> &CSkinnedMesh::getAllJoints()
{
	return AllJoints;
}


const core::array<SJoint*> &CSkinnedMesh::getAllJoints() const
{
	return AllJoints;
}
...
SJoint *CSkinnedMesh::addJoint(SJoint *parent)
{
...
SPositionKey *CSkinnedMesh::addPositionKey(SJoint *joint)
{
	if (!joint)
		return 0;
...
SScaleKey *CSkinnedMesh::addScaleKey(SJoint *joint)
{
	if (!joint)
		return 0;
...
SRotationKey *CSkinnedMesh::addRotationKey(SJoint *joint)
{
	if (!joint)
		return 0;
...
SWeight *CSkinnedMesh::addWeight(SJoint *joint)
{
	if (!joint)
		return 0;
