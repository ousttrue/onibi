...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../release
  TARGET     = $(TARGETDIR)/App_CollisionInterfaceDemo.exe
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/App_CollisionInterfaceDemo
  TARGETDIR  = ../release64
  TARGET     = $(TARGETDIR)/App_CollisionInterfaceDemo.exe
  DEFINES   += -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -DFREEGLUT_STATIC
  INCLUDES  += -I../bullet -IOpenGL -I../freeglut/include
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/App_CollisionInterfaceDemo
  TARGETDIR  = ../debug64
  TARGET     = $(TARGETDIR)/App_CollisionInterfaceDemo.exe
  DEFINES   += -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -DFREEGLUT_STATIC
  INCLUDES  += -I../bullet -IOpenGL -I../freeglut/include
...
$(OBJDIR)/CollisionInterfaceDemo.o: CollisionInterfaceDemo/CollisionInterfaceDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/main.o: CollisionInterfaceDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/Win32CollisionInterfaceDemo.o: CollisionInterfaceDemo/Win32CollisionInterfaceDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
