...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../release
  TARGET     = $(TARGETDIR)/App_ConcaveConvexcastDemo.exe
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/App_ConcaveConvexcastDemo
  TARGETDIR  = ../release64
  TARGET     = $(TARGETDIR)/App_ConcaveConvexcastDemo.exe
  DEFINES   += -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -DFREEGLUT_STATIC
  INCLUDES  += -I../bullet -IOpenGL -I../freeglut/include
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/App_ConcaveConvexcastDemo
  TARGETDIR  = ../debug64
  TARGET     = $(TARGETDIR)/App_ConcaveConvexcastDemo.exe
  DEFINES   += -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -DFREEGLUT_STATIC
  INCLUDES  += -I../bullet -IOpenGL -I../freeglut/include
...
$(OBJDIR)/ConcaveConvexcastDemo.o: ConcaveConvexcastDemo/ConcaveConvexcastDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/main.o: ConcaveConvexcastDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
