...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../release
  TARGET     = $(TARGETDIR)/App_EPAPenDepthDemo.exe
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/App_EPAPenDepthDemo
  TARGETDIR  = ../release64
  TARGET     = $(TARGETDIR)/App_EPAPenDepthDemo.exe
  DEFINES   += -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -DFREEGLUT_STATIC
  INCLUDES  += -I../bullet -IOpenGL -I../freeglut/include
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/App_EPAPenDepthDemo
  TARGETDIR  = ../debug64
  TARGET     = $(TARGETDIR)/App_EPAPenDepthDemo.exe
  DEFINES   += -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -DFREEGLUT_STATIC
  INCLUDES  += -I../bullet -IOpenGL -I../freeglut/include
...
$(OBJDIR)/PenetrationTestBullet.o: EPAPenDepthDemo/PenetrationTestBullet.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
