		...
		if (collisionShape->isConcave())
		{
			...
			if (collisionShape->getShapeType()==TRIANGLE_MESH_SHAPE_PROXYTYPE)
			{
				...
				struct BridgeTriangleRaycastCallback : public btTriangleRaycastCallback
				{
					...
					BridgeTriangleRaycastCallback( const btVector3& from,const btVector3& to,
						RayResultCallback* resultCallback, btCollisionObject* collisionObject,btTriangleMeshShape*	triangleMesh,const btTransform& colObjWorldTransform):
					//@BP Mod
			...
			} else
			{
				...
				struct BridgeTriangleRaycastCallback : public btTriangleRaycastCallback
				{
					...
					BridgeTriangleRaycastCallback( const btVector3& from,const btVector3& to,
						RayResultCallback* resultCallback, btCollisionObject* collisionObject,btConcaveShape*	triangleMesh, const btTransform& colObjWorldTransform):
					//@BP Mod
					btTriangleRaycastCallback(from,to, resultCallback->m_flags),
						m_resultCallback(resultCallback),
						m_collisionObject(collisionObject),
			...
			if (collisionShape->isCompound())
			{
				struct LocalInfoAdder2 : public RayResultCallback
				{
					...
					virtual btScalar addSingleResult (LocalRayResult &r, bool b)
					{
						LocalShapeInfo shapeInfo;
			...
			if (collisionShape->getShapeType()==TRIANGLE_MESH_SHAPE_PROXYTYPE)
			{
				...
				struct BridgeTriangleConvexcastCallback : public btTriangleConvexcastCallback
				{
					...
					BridgeTriangleConvexcastCallback(const btConvexShape* castShape, const btTransform& from,const btTransform& to,
						ConvexResultCallback* resultCallback, btCollisionObject* collisionObject,btTriangleMeshShape*	triangleMesh, const btTransform& triangleToWorld):
			...
			} else
			{
				...
				} else
				{
					...
					struct BridgeTriangleConvexcastCallback : public btTriangleConvexcastCallback
					{
						...
						BridgeTriangleConvexcastCallback(const btConvexShape* castShape, const btTransform& from,const btTransform& to,
							ConvexResultCallback* resultCallback, btCollisionObject* collisionObject,btConcaveShape*	triangleMesh, const btTransform& triangleToWorld):
						btTriangleConvexcastCallback(castShape, from,to, triangleToWorld, triangleMesh->getMargin()),
							m_resultCallback(resultCallback),
							m_collisionObject(collisionObject),
							m_triangleMesh(triangleMesh)
			...
			if (collisionShape->isCompound())
			{
				...
				for (i=0;i<compoundShape->getNumChildShapes();i++)
				{
                    ...
                    struct	LocalInfoAdder : public ConvexResultCallback {
                            ...
                            virtual btScalar addSingleResult (LocalConvexResult&	r,	bool b)
                            {
                                    LocalShapeInfo	shapeInfo;
                                    shapeInfo.m_shapePart = -1;
                                    shapeInfo.m_triangleIndex = m_i;
...
struct btSingleRayCallback : public btBroadphaseRayCallback
{
	...
	btSingleRayCallback(const btVector3& rayFromWorld,const btVector3& rayToWorld,const btCollisionWorld* world,RayResultCallback& resultCallback)
...
struct btSingleSweepCallback : public btBroadphaseRayCallback
{
	...
	btSingleSweepCallback(const btConvexShape* castShape, const btTransform& convexFromTrans,const btTransform& convexToTrans,const btCollisionWorld* world,ConvexResultCallback& resultCallback,btScalar allowedPenetration)
...
struct btBridgedManifoldResult : public btManifoldResult
{
	...
	btBridgedManifoldResult( btCollisionObject* obj0,btCollisionObject* obj1,ContactResultCallback& resultCallback )
