  ...
  namespace pmd {
    ...
    inline std::ostream &operator<<(std::ostream &os, const Loader &rhs)
    {
      os
        ...
        ;
      for(auto it=rhs.materials.begin(); it!=rhs.materials.end(); ++it){
        os << *it << std::endl;
      }
      ...
      os
        ...
        ;
      for(auto it=rhs.bones.begin(); it!=rhs.bones.end(); ++it){
        os << *it << std::endl;
      }
      ...
      os
        ...
        ;
      for(auto it=rhs.ik_list.begin(); it!=rhs.ik_list.end(); ++it){
        os << *it << std::endl;
      }
      ...
      os
        ...
        ;
      for(auto it=rhs.morph_list.begin(); it!=rhs.morph_list.end(); ++it){
        os << *it << std::endl;
      }
